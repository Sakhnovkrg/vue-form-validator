...
export default [
  ...
  },
  {
    ignores: [
      ...
      'node_modules/**',
      '*.d.ts',
      // Документация — отдельный подпроект со своим package.json и своей
      // сборкой, в пакет не попадает. Плюс в `.vitepress/cache` лежат
      // сгенерированные бандлы зависимостей, на которых линтер выдаёт
      // сотни ошибок в чужом коде
      'docs/**',
    ],
  },
]
